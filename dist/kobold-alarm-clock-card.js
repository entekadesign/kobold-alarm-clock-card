...
class $b2cd7c9abb677932$export$cfa71a29f5c0676d {
    ...
    _evaluate() {
        ...
        if ((nextAlarm.date < dateToday || (0, (/*@__PURE__*/$parcel$interopDefault($7b2a0b4b3c09b2f0$exports)))().subtract(1, 'minute') > (0, (/*@__PURE__*/$parcel$interopDefault($7b2a0b4b3c09b2f0$exports)))(nextAlarm.date_time) && nextAlarm.date === dateToday) && !this.isAlarmRinging()) (0, $1656612fccd2685e$export$4dc2b60021baefca).throttle(()=>{
...
class $3ce236f40c9404d3$var$AlarmPicker extends (0, $da1fd7e2c62fd6f3$export$3f2f9f5909897157) {
    ...
    _clickHandler() {
        ...
        if (isEnabled && !isOverridden || !isEnabled && !isOverridden) timeArray = (0, (/*@__PURE__*/$parcel$interopDefault($7b2a0b4b3c09b2f0$exports)))(this.time, this._alarmTimeFormat()).format('HH:mm').split(':');
    ...
    async _saveNextAlarm(nextAlarmConfig) {
        try {
            ...
            if (nextAlarmConfig.next_alarm.overridden) {
                ...
                nextAlarm = (0, $b2cd7c9abb677932$export$cfa71a29f5c0676d).createNextAlarm({
                    enabled: true,
                    time: nextAlarmTime.format('HH:mm:ss')
                }, true, true);
            } else {
                ...
                const forToday = (0, (/*@__PURE__*/$parcel$interopDefault($7b2a0b4b3c09b2f0$exports)))().format('HH:mm:ss') < this._config[dayToday].time;
                const newAlarm = forToday ? this._config[dayToday] : this._config[dayTomorrow];
                nextAlarm = (0, $b2cd7c9abb677932$export$cfa71a29f5c0676d).createNextAlarm(newAlarm, forToday);
            }
...
(0, $6dd3ba7ab41ebe11$export$29e00dfd3077644b)([
    (0, $e978bded0760ae3c$export$ca000e230c0caa3e)()
], $d6cbb17091a7de38$var$KoboldCardEditor.prototype, "_hass", void 0);
(0, $6dd3ba7ab41ebe11$export$29e00dfd3077644b)([
    (0, $e978bded0760ae3c$export$ca000e230c0caa3e)()
], $d6cbb17091a7de38$var$KoboldCardEditor.prototype, "_config", void 0);
(0, $6dd3ba7ab41ebe11$export$29e00dfd3077644b)([
    (0, $e978bded0760ae3c$export$ca000e230c0caa3e)()
], $d6cbb17091a7de38$var$KoboldCardEditor.prototype, "_selectedTab", void 0);
(0, $6dd3ba7ab41ebe11$export$29e00dfd3077644b)([
    (0, $e978bded0760ae3c$export$ca000e230c0caa3e)()
], $d6cbb17091a7de38$var$KoboldCardEditor.prototype, "_nextAlarmConfig", void 0);
(0, $6dd3ba7ab41ebe11$export$29e00dfd3077644b)([
    (0, $6bc2845c2b7eed7f$export$d541bacb2bda4494)({
        attribute: false,
        reflect: false
    })
], $d6cbb17091a7de38$var$KoboldCardEditor.prototype, "alarmController", void 0);
$d6cbb17091a7de38$var$KoboldCardEditor = (0, $6dd3ba7ab41ebe11$export$29e00dfd3077644b)([
    (0, $fcbcbba309c0f62b$export$da64fc29f17f9d0e)('kobold-card-editor')
], $d6cbb17091a7de38$var$KoboldCardEditor);
...
class $2109a11e0895c6b1$var$KoboldAlarmClockCard extends (0, $da1fd7e2c62fd6f3$export$3f2f9f5909897157) {
    ...
    static getStubConfig(hass, entities) {
        const ents = entities.filter((e)=>{
            ...
            return (0, $b2cd7c9abb677932$export$cfa71a29f5c0676d).DOMAINS_ALARM_ENTITIES.includes(domain);
        });
        const alarmEntities = [
    ...
    _updateTime(force = false) {
        ...
        if (this._clockQ && (force || this._time !== time)) {
            ...
            if (this._alarmController.controllerConfigLastUpdated !== this._config.last_updated) {
                ...
                this._hass.callService('system_log', 'write', {
                    'message': '*** updateTime; controller config and card config differ',
                    'level': 'info'
                });
            }
    ...
    _onAlarmChanged(event) {
        ...
        // allow animations to complete before saving
        window.setTimeout(()=>{
            this._alarmController.nextAlarm = (0, $b2cd7c9abb677932$export$cfa71a29f5c0676d).createNextAlarm(data, true, true);
        }, 250);
    }
